"""Legacy executable module smoke diagnostic for TravelAgent2.
...
This remains a manually invoked compatibility diagnostic. It is intentionally
not named as a pytest module because it owns its process lifecycle and exits
with a summary code.
"""
...
model_modules = [
    ...
    "models.city_info",
    "models.travel_slots",
    "models.user_trip_history",
    "models.knowledge_tip",
    "models.spot_distance",
    "models.transport_hub",
    "models.data_audit_log",
    "models.dead_letter_archive",
    "models.planning_log",
    "models.user_modification_log",
    "models.user_profile_vector",
]
...
def test_weather_query_fallback():
    from skills.weather_query import CITY_COORDS, _estimate_temp
...
def test_auth_module():
    from core.auth import create_access_token, create_guest_token
...
def test_circuit_breaker():
    ...
    cb = CircuitBreaker(
        "test", failure_threshold=0.5, min_failures=3, window_seconds=10, recovery_seconds=5
    )
...
def test_enhancements():
    ...
    profile = UserProfile(
        destination="成都", travel_days=3, has_elderly=True, has_children=True, pace="intensive"
    )
