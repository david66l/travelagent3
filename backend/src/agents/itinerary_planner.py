    ...
    CITY_DEFAULTS: dict[str, list[ScoredPOI]] = {
        ...
        "北京": [
            ...
            ScoredPOI(
                ...
                area="东城区",
                indoor_outdoor="mixed",
                location=Location(lat=39.911057, lng=116.410876),
                ticket_price=0,
            ),
            ScoredPOI(
                name="798艺术区",
                ...
                area="朝阳区",
                indoor_outdoor="mixed",
                location=Location(lat=39.985326, lng=116.497772),
                ticket_price=0,
            ),
            ScoredPOI(
                name="南锣鼓巷",
                ...
                area="东城区",
                indoor_outdoor="outdoor",
                location=Location(lat=39.937243, lng=116.403076),
                ticket_price=0,
            ),
            ScoredPOI(
                name="鸟巢/水立方",
                ...
                area="朝阳区",
                indoor_outdoor="outdoor",
                location=Location(lat=39.992928, lng=116.396531),
                ticket_price=50,
            ),
            ScoredPOI(
                name="什刹海",
                category="attraction",
                score=0.8,
                description="老北京风貌区，酒吧街",
                tags=["湖景", "夜生活", "胡同"],
                best_time="晚上",
                recommended_hours="2小时",
                area="西城区",
                indoor_outdoor="mixed",
                location=Location(lat=39.940430, lng=116.385331),
                ticket_price=0,
            ),
            ScoredPOI(
                name="国家博物馆",
                category="attraction",
                score=0.85,
                description="中国历史文物展览",
                tags=["博物馆", "历史", "文化"],
                best_time="上午",
                recommended_hours="2-3小时",
                area="天安门",
                indoor_outdoor="indoor",
                location=Location(lat=39.905490, lng=116.397650),
                ticket_price=0,
            ),
            ScoredPOI(
                name="景山公园",
                ...
                area="西城区",
                indoor_outdoor="outdoor",
                location=Location(lat=39.924418, lng=116.397087),
                ticket_price=2,
            ),
            ScoredPOI(
                name="北海公园",
                ...
                area="西城区",
                indoor_outdoor="mixed",
                location=Location(lat=39.924175, lng=116.388862),
                ticket_price=10,
            ),
            ScoredPOI(
                name="前门大街",
            ...
            ScoredPOI(
                ...
                area="东城区",
                indoor_outdoor="mixed",
                location=Location(lat=39.947200, lng=116.417755),
                ticket_price=25,
            ),
            ScoredPOI(
                name="恭王府",
                ...
                area="西城区",
                indoor_outdoor="mixed",
                location=Location(lat=39.936185, lng=116.386460),
                ticket_price=40,
            ),
            ScoredPOI(
                name="全聚德",
        ...
        "广州": [
            ScoredPOI(
                ...
                category="attraction",
                score=0.9,
                description="小蛮腰，广州地标",
                tags=["地标", "观景", "夜景"],
                best_time="晚上",
                recommended_hours="2-3小时",
                area="海珠区",
                indoor_outdoor="mixed",
                location=Location(lat=23.1065, lng=113.3255),
                ticket_price=150,
            ),
            ScoredPOI(
                name="陈家祠",
                ...
                area="荔湾区",
                indoor_outdoor="mixed",
                location=Location(lat=23.1288, lng=113.2458),
                ticket_price=10,
            ),
            ScoredPOI(
                name="沙面",
                ...
                area="荔湾区",
                indoor_outdoor="outdoor",
                location=Location(lat=23.1092, lng=113.2447),
                ticket_price=0,
            ),
            ScoredPOI(
                name="北京路步行街",
                ...
                area="越秀区",
                indoor_outdoor="outdoor",
                location=Location(lat=23.1247, lng=113.2669),
                ticket_price=0,
            ),
            ScoredPOI(
                name="上下九步行街",
                ...
                area="荔湾区",
                indoor_outdoor="outdoor",
                location=Location(lat=23.1175, lng=113.2458),
                ticket_price=0,
            ),
            ScoredPOI(
                name="越秀公园",
                category="attraction",
                score=0.8,
                description="城市绿肺，五羊雕像",
                tags=["公园", "休闲", "地标"],
                best_time="上午",
                recommended_hours="2小时",
                area="越秀区",
                indoor_outdoor="outdoor",
                location=Location(lat=23.1408, lng=113.2597),
                ticket_price=0,
            ),
            ScoredPOI(
                name="珠江夜游",
            ...
            ScoredPOI(
                ...
                category="attraction",
                score=0.8,
                description="广东历史文化展览",
                tags=["博物馆", "历史", "文化"],
                best_time="上午",
                recommended_hours="2-3小时",
                area="珠江新城",
                indoor_outdoor="indoor",
                location=Location(lat=23.1108, lng=113.3242),
                ticket_price=0,
            ),
            ScoredPOI(
                name="白云山",
                ...
                area="白云区",
                indoor_outdoor="outdoor",
                location=Location(lat=23.1833, lng=113.3000),
                ticket_price=5,
            ),
            ScoredPOI(
                name="长隆欢乐世界",
                ...
                area="番禺区",
                indoor_outdoor="mixed",
                location=Location(lat=22.9986, lng=113.3242),
                ticket_price=250,
            ),
            ScoredPOI(
                name="石室圣心大教堂",
                category="attraction",
                score=0.8,
                description="哥特式建筑，全石结构",
                tags=["建筑", "宗教", "拍照"],
                best_time="上午",
                recommended_hours="1小时",
                area="越秀区",
                indoor_outdoor="mixed",
                location=Location(lat=23.1175, lng=113.2597),
                ticket_price=0,
            ),
            ScoredPOI(
                name="红砖厂",
            ...
            ScoredPOI(
                ...
                area="珠江新城",
                indoor_outdoor="outdoor",
                location=Location(lat=23.1208, lng=113.3255),
                ticket_price=0,
            ),
            ScoredPOI(
                name="华南植物园",
                ...
                area="天河区",
                indoor_outdoor="outdoor",
                location=Location(lat=23.1833, lng=113.3667),
                ticket_price=20,
            ),
            ScoredPOI(
                name="点都德",
        ...
        "成都": [
            ScoredPOI(
                ...
                area="青羊区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.6636, lng=104.0556),
                ticket_price=0,
            ),
            ScoredPOI(
                name="锦里",
                ...
                area="武侯祠",
                indoor_outdoor="outdoor",
                location=Location(lat=30.6458, lng=104.0458),
                ticket_price=0,
            ),
            ScoredPOI(
                name="大熊猫繁育基地",
                ...
                area="新都区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.7333, lng=104.1500),
                ticket_price=55,
            ),
            ScoredPOI(
                name="武侯祠",
                ...
                area="武侯区",
                indoor_outdoor="mixed",
                location=Location(lat=30.6417, lng=104.0458),
                ticket_price=50,
            ),
            ScoredPOI(
                name="杜甫草堂",
                ...
                area="青羊区",
                indoor_outdoor="mixed",
                location=Location(lat=30.6597, lng=104.0289),
                ticket_price=50,
            ),
            ScoredPOI(
                name="春熙路",
                ...
                area="锦江区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.6569, lng=104.0814),
                ticket_price=0,
            ),
            ScoredPOI(
                name="青城山",
                category="attraction",
                score=0.85,
                description="道教名山，避暑胜地",
                tags=["登山", "道教", "自然"],
                best_time="全天",
                recommended_hours="半天",
                area="都江堰",
                indoor_outdoor="outdoor",
                location=Location(lat=30.9083, lng=103.5667),
                ticket_price=80,
            ),
            ScoredPOI(
                name="都江堰",
                category="attraction",
                score=0.9,
                description="世界文化遗产水利工程",
                tags=["历史", "工程", "文化"],
                best_time="全天",
                recommended_hours="半天",
                area="都江堰",
                indoor_outdoor="outdoor",
                location=Location(lat=31.0000, lng=103.6167),
                ticket_price=80,
            ),
            ScoredPOI(
                name="文殊院",
                ...
                area="青羊区",
                indoor_outdoor="mixed",
                location=Location(lat=30.6750, lng=104.0667),
                ticket_price=0,
            ),
            ScoredPOI(
                name="人民公园",
                ...
                area="青羊区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.6625, lng=104.0569),
                ticket_price=0,
            ),
            ScoredPOI(
                name="九眼桥",
                ...
                area="武侯区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.6375, lng=104.0875),
                ticket_price=0,
            ),
            ScoredPOI(
                name="金沙遗址",
                ...
                area="青羊区",
                indoor_outdoor="mixed",
                location=Location(lat=30.6833, lng=104.0167),
                ticket_price=70,
            ),
            ScoredPOI(
                name="太古里",
            ...
            ScoredPOI(
                ...
                area="双流区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.3167, lng=103.9833),
                ticket_price=0,
            ),
            ScoredPOI(
                name="东郊记忆",
                ...
                area="成华区",
                indoor_outdoor="mixed",
                location=Location(lat=30.6750, lng=104.1167),
                ticket_price=0,
            ),
            ScoredPOI(
                name="蜀大侠火锅",
        ...
        "杭州": [
            ScoredPOI(
                ...
                category="attraction",
                score=0.95,
                description="世界文化遗产，杭州名片",
                tags=["湖景", "文化", "拍照"],
                best_time="全天",
                recommended_hours="半天",
                area="西湖区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.2456, lng=120.1407),
                ticket_price=0,
            ),
            ScoredPOI(
                name="灵隐寺",
                ...
                area="西湖区",
                indoor_outdoor="mixed",
                location=Location(lat=30.2408, lng=120.0983),
                ticket_price=75,
            ),
            ScoredPOI(
                name="宋城",
                ...
                area="西湖区",
                indoor_outdoor="mixed",
                location=Location(lat=30.1886, lng=120.1124),
                ticket_price=320,
            ),
            ScoredPOI(
                name="西溪湿地",
                category="attraction",
                score=0.8,
                description="城市湿地，非诚勿扰取景地",
                tags=["自然", "湿地", "休闲"],
                best_time="上午",
                recommended_hours="3-4小时",
                area="西湖区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.2715, lng=120.0632),
                ticket_price=80,
            ),
            ScoredPOI(
                name="河坊街",
                category="attraction",
                score=0.75,
                description="杭州老街，传统手工艺品",
                tags=["古街", "购物", "美食"],
                best_time="下午",
                recommended_hours="2小时",
                area="上城区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.2430, lng=120.1686),
                ticket_price=0,
            ),
            ScoredPOI(
                name="千岛湖",
                ...
                area="淳安县",
                indoor_outdoor="outdoor",
                location=Location(lat=29.6041, lng=118.9907),
                ticket_price=150,
            ),
            ScoredPOI(
                name="龙井村",
                category="attraction",
                score=0.8,
                description="龙井茶原产地，茶文化体验",
                tags=["茶文化", "自然", "乡村"],
                best_time="上午",
                recommended_hours="2小时",
                area="西湖区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.2214, lng=120.1244),
                ticket_price=0,
            ),
            ScoredPOI(
                name="断桥残雪",
                category="attraction",
                score=0.85,
                description="西湖十景之一，白娘子传说",
                tags=["传说", "湖景", "拍照"],
                best_time="傍晚",
                recommended_hours="1小时",
                area="西湖区",
                indoor_outdoor="outdoor",
                location=Location(lat=30.2596, lng=120.1478),
                ticket_price=0,
            ),
            ScoredPOI(
                name="雷峰塔",
                ...
                area="西湖区",
                indoor_outdoor="mixed",
                location=Location(lat=30.2314, lng=120.1493),
                ticket_price=40,
            ),
            ScoredPOI(
                name="楼外楼",
                ...
                area="西湖区",
                indoor_outdoor="indoor",
                location=Location(lat=30.2586, lng=120.1432),
                ticket_price=0,
            ),
            ScoredPOI(
                name="知味小笼",
                ...
                area="上城区",
                indoor_outdoor="indoor",
                location=Location(lat=30.2580, lng=120.1650),
                ticket_price=0,
            ),
            ScoredPOI(
                name="外婆家",
                ...
                area="下城区",
                indoor_outdoor="indoor",
                location=Location(lat=30.2700, lng=120.1600),
                ticket_price=0,
            ),
        ],
        "西安": [
            ScoredPOI(
                ...
                area="临潼区",
                indoor_outdoor="mixed",
                location=Location(lat=34.3841, lng=109.2785),
                ticket_price=120,
            ),
            ScoredPOI(
                name="大雁塔",
                ...
                area="雁塔区",
                indoor_outdoor="mixed",
                location=Location(lat=34.2204, lng=108.9685),
                ticket_price=50,
            ),
            ScoredPOI(
                name="古城墙",
                category="attraction",
                score=0.9,
                description="中国现存最完整古城墙",
                tags=["历史", "骑行", "观景"],
                best_time="傍晚",
                recommended_hours="2-3小时",
                area="碑林区",
                indoor_outdoor="outdoor",
                location=Location(lat=34.2566, lng=108.9607),
                ticket_price=54,
            ),
            ScoredPOI(
                name="回民街",
                category="attraction",
                score=0.8,
                description="西安美食文化街区",
                tags=["美食", "文化", "夜市"],
                best_time="晚上",
                recommended_hours="2小时",
                area="莲湖区",
                indoor_outdoor="outdoor",
                location=Location(lat=34.2624, lng=108.9467),
                ticket_price=0,
            ),
            ScoredPOI(
                name="华清宫",
                category="attraction",
                score=0.85,
                description="唐玄宗与杨贵妃爱情故事",
                tags=["历史", "温泉", "演出"],
                best_time="下午",
                recommended_hours="3小时",
                area="临潼区",
                indoor_outdoor="mixed",
                location=Location(lat=34.3633, lng=109.2124),
                ticket_price=120,
            ),
            ScoredPOI(
                name="大唐芙蓉园",
                ...
                area="雁塔区",
                indoor_outdoor="mixed",
                location=Location(lat=34.2187, lng=108.9695),
                ticket_price=120,
            ),
            ScoredPOI(
                name="陕西历史博物馆",
                ...
                area="雁塔区",
                indoor_outdoor="indoor",
                location=Location(lat=34.2264, lng=108.9604),
                ticket_price=0,
            ),
            ScoredPOI(
                name="钟楼",
                ...
                area="碑林区",
                indoor_outdoor="mixed",
                location=Location(lat=34.2611, lng=108.9425),
                ticket_price=30,
            ),
            ScoredPOI(
                name="鼓楼",
                category="attraction",
                score=0.8,
                description="中国古代最大鼓楼",
                tags=["地标", "历史", "建筑"],
                best_time="晚上",
                recommended_hours="1小时",
                area="莲湖区",
                indoor_outdoor="mixed",
                location=Location(lat=34.2617, lng=108.9391),
                ticket_price=30,
            ),
            ScoredPOI(
                name="肉夹馍",
                ...
                area="莲湖区",
                indoor_outdoor="indoor",
                location=Location(lat=34.2600, lng=108.9400),
                ticket_price=0,
            ),
            ScoredPOI(
                name="羊肉泡馍",
                ...
                area="莲湖区",
                indoor_outdoor="indoor",
                location=Location(lat=34.2620, lng=108.9450),
                ticket_price=0,
            ),
            ScoredPOI(
                name="凉皮",
                category="restaurant",
                score=0.75,
                description="西安夏日解暑小吃",
                tags=["小吃", "夏日", "传统"],
                best_time="午餐",
                recommended_hours="1小时",
                area="莲湖区",
                indoor_outdoor="indoor",
                location=Location(lat=34.2610, lng=108.9440),
                ticket_price=0,
            ),
        ],
        "重庆": [
            ScoredPOI(
                ...
                area="渝中区",
                indoor_outdoor="mixed",
                location=Location(lat=29.5632, lng=106.5803),
                ticket_price=0,
            ),
            ScoredPOI(
                name="解放碑",
            ...
            ScoredPOI(
                ...
                area="沙坪坝区",
                indoor_outdoor="outdoor",
                location=Location(lat=29.5823, lng=106.4485),
                ticket_price=0,
            ),
            ScoredPOI(
                name="长江索道",
                ...
                area="渝中区",
                indoor_outdoor="outdoor",
                location=Location(lat=29.5565, lng=106.5869),
                ticket_price=30,
            ),
            ScoredPOI(
                name="武隆天坑",
                category="attraction",
                score=0.9,
                description="世界自然遗产，喀斯特地貌",
                tags=["自然", "地质", "世界遗产"],
                best_time="全天",
                recommended_hours="全天",
                area="武隆区",
                indoor_outdoor="outdoor",
                location=Location(lat=29.4276, lng=107.7188),
                ticket_price=125,
            ),
            ScoredPOI(
                name="朝天门",
                ...
                area="渝中区",
                indoor_outdoor="outdoor",
                location=Location(lat=29.5685, lng=106.5855),
                ticket_price=0,
            ),
            ScoredPOI(
                name="鹅岭二厂",
                category="attraction",
                score=0.75,
                description="文创园区，文艺青年聚集地",
                tags=["文创", "拍照", "艺术"],
                best_time="下午",
                recommended_hours="2小时",
                area="渝中区",
                indoor_outdoor="mixed",
                location=Location(lat=29.5538, lng=106.5406),
                ticket_price=0,
            ),
            ScoredPOI(
                name="南山一棵树",
                category="attraction",
                score=0.8,
                description="俯瞰重庆夜景最佳地点",
                tags=["夜景", "观景", "拍照"],
                best_time="晚上",
                recommended_hours="1-2小时",
                area="南岸区",
                indoor_outdoor="outdoor",
                location=Location(lat=29.5562, lng=106.6054),
                ticket_price=30,
            ),
            ScoredPOI(
                name="四川美术学院",
                category="attraction",
                score=0.75,
                description="涂鸦街，艺术氛围浓厚",
                tags=["艺术", "涂鸦", "拍照"],
                best_time="下午",
                recommended_hours="2小时",
                area="九龙坡区",
                indoor_outdoor="outdoor",
                location=Location(lat=29.6036, lng=106.3014),
                ticket_price=0,
            ),
            ScoredPOI(
                name="重庆火锅",
        ...
        "深圳": [
            ScoredPOI(
                ...
                category="attraction",
                score=0.85,
                description="微缩景观主题公园",
                tags=["亲子", "地标", "娱乐"],
                best_time="全天",
                recommended_hours="半天",
                area="南山区",
                indoor_outdoor="mixed",
                location=Location(lat=22.5358, lng=113.9804),
                ticket_price=220,
            ),
            ScoredPOI(
                name="欢乐谷",
                ...
                area="南山区",
                indoor_outdoor="mixed",
                location=Location(lat=22.5404, lng=113.9836),
                ticket_price=230,
            ),
            ScoredPOI(
                name="大梅沙",
                ...
                area="盐田区",
                indoor_outdoor="outdoor",
                location=Location(lat=22.5947, lng=114.3061),
                ticket_price=0,
            ),
            ScoredPOI(
                name="华侨城",
                ...
                area="南山区",
                indoor_outdoor="mixed",
                location=Location(lat=22.5388, lng=113.9817),
                ticket_price=0,
            ),
            ScoredPOI(
                name="深圳湾公园",
                category="attraction",
                score=0.8,
                description="观鸟看海，城市绿肺",
                tags=["自然", "休闲", "海景"],
                best_time="傍晚",
                recommended_hours="2小时",
                area="南山区",
                indoor_outdoor="outdoor",
                location=Location(lat=22.5180, lng=113.9441),
                ticket_price=0,
            ),
            ScoredPOI(
                name="莲花山公园",
                ...
                area="福田区",
                indoor_outdoor="outdoor",
                location=Location(lat=22.5538, lng=114.0511),
                ticket_price=0,
            ),
            ScoredPOI(
                name="东门老街",
                category="attraction",
                score=0.75,
                description="深圳最老牌商业街",
                tags=["购物", "美食", "老街"],
                best_time="下午",
                recommended_hours="2小时",
                area="罗湖区",
                indoor_outdoor="outdoor",
                location=Location(lat=22.5456, lng=114.0592),
                ticket_price=0,
            ),
            ScoredPOI(
                name="海上世界",
                ...
                area="南山区",
                indoor_outdoor="mixed",
                location=Location(lat=22.4856, lng=113.9136),
                ticket_price=0,
            ),
            ScoredPOI(
                name="大鹏所城",
                ...
                area="大鹏新区",
                indoor_outdoor="outdoor",
                location=Location(lat=22.6000, lng=114.5500),
                ticket_price=0,
            ),
            ScoredPOI(
                name="潮汕牛肉火锅",
        ...
        "南京": [
            ScoredPOI(
                ...
                area="玄武区",
                indoor_outdoor="outdoor",
                location=Location(lat=32.0558, lng=118.8493),
                ticket_price=0,
            ),
            ScoredPOI(
                name="夫子庙",
                category="attraction",
                score=0.85,
                description="秦淮河风光带核心",
                tags=["古街", "文化", "夜景"],
                best_time="晚上",
                recommended_hours="2小时",
                area="秦淮区",
                indoor_outdoor="mixed",
                location=Location(lat=32.0227, lng=118.7943),
                ticket_price=0,
            ),
            ScoredPOI(
                name="秦淮河",
                category="attraction",
                score=0.85,
                description="十里秦淮，金陵风月",
                tags=["夜景", "游船", "文化"],
                best_time="晚上",
                recommended_hours="2小时",
                area="秦淮区",
                indoor_outdoor="outdoor",
                location=Location(lat=32.0220, lng=118.7940),
                ticket_price=0,
            ),
            ScoredPOI(
                name="明孝陵",
                category="attraction",
                score=0.85,
                description="明朝开国皇帝陵寝",
                tags=["历史", "世界遗产", "神道"],
                best_time="上午",
                recommended_hours="3小时",
                area="玄武区",
                indoor_outdoor="outdoor",
                location=Location(lat=32.0572, lng=118.8466),
                ticket_price=70,
            ),
            ScoredPOI(
                name="总统府",
                ...
                area="玄武区",
                indoor_outdoor="mixed",
                location=Location(lat=32.0438, lng=118.7981),
                ticket_price=35,
            ),
            ScoredPOI(
                name="鸡鸣寺",
                category="attraction",
                score=0.8,
                description="南京最古老的佛寺",
                tags=["佛教", "樱花", "历史"],
                best_time="上午",
                recommended_hours="1-2小时",
                area="玄武区",
                indoor_outdoor="mixed",
                location=Location(lat=32.0576, lng=118.7444),
                ticket_price=10,
            ),
            ScoredPOI(
                name="玄武湖",
                ...
                area="玄武区",
                indoor_outdoor="outdoor",
                location=Location(lat=32.0605, lng=118.7977),
                ticket_price=0,
            ),
            ScoredPOI(
                name="南京博物院",
                ...
                area="玄武区",
                indoor_outdoor="indoor",
                location=Location(lat=32.0426, lng=118.8209),
                ticket_price=0,
            ),
            ScoredPOI(
                name="老门东",
                category="attraction",
                score=0.8,
                description="南京传统民居聚集地",
                tags=["古街", "美食", "文化"],
                best_time="下午",
                recommended_hours="2小时",
                area="秦淮区",
                indoor_outdoor="outdoor",
                location=Location(lat=32.0156, lng=118.7923),
                ticket_price=0,
            ),
            ScoredPOI(
                name="鸭血粉丝汤",
                ...
                area="秦淮区",
                indoor_outdoor="indoor",
                location=Location(lat=32.0600, lng=118.7800),
                ticket_price=0,
            ),
            ScoredPOI(
                name="盐水鸭",
        ...
        "厦门": [
            ScoredPOI(
                ...
                category="attraction",
                score=0.9,
                description="海上花园，万国建筑",
                tags=["海岛", "建筑", "文艺"],
                best_time="全天",
                recommended_hours="全天",
                area="思明区",
                indoor_outdoor="mixed",
                location=Location(lat=24.4482, lng=118.0823),
                ticket_price=35,
            ),
            ScoredPOI(
                name="南普陀寺",
                ...
                area="思明区",
                indoor_outdoor="mixed",
                location=Location(lat=24.4396, lng=118.0982),
                ticket_price=0,
            ),
            ScoredPOI(
                name="厦门大学",
                ...
                area="思明区",
                indoor_outdoor="outdoor",
                location=Location(lat=24.4393, lng=118.0973),
                ticket_price=0,
            ),
            ScoredPOI(
                name="环岛路",
                ...
                area="思明区",
                indoor_outdoor="outdoor",
                location=Location(lat=24.4625, lng=118.1331),
                ticket_price=0,
            ),
            ScoredPOI(
                name="曾厝垵",
                ...
                area="思明区",
                indoor_outdoor="mixed",
                location=Location(lat=24.4317, lng=118.1271),
                ticket_price=0,
            ),
            ScoredPOI(
                name="中山路步行街",
                ...
                area="思明区",
                indoor_outdoor="outdoor",
                location=Location(lat=24.4624, lng=118.0834),
                ticket_price=0,
            ),
            ScoredPOI(
                name="胡里山炮台",
                ...
                area="思明区",
                indoor_outdoor="outdoor",
                location=Location(lat=24.4391, lng=118.1028),
                ticket_price=25,
            ),
            ScoredPOI(
                name="园林植物园",
                ...
                area="思明区",
                indoor_outdoor="outdoor",
                location=Location(lat=24.4450, lng=118.1110),
                ticket_price=30,
            ),
            ScoredPOI(
                name="沙坡尾",
                category="attraction",
                score=0.8,
                description="厦门港发源地，艺术西区",
                tags=["艺术", "文创", "老港口"],
                best_time="下午",
                recommended_hours="2小时",
                area="思明区",
                indoor_outdoor="mixed",
                location=Location(lat=24.4400, lng=118.1050),
                ticket_price=0,
            ),
            ScoredPOI(
                name="沙茶面",
                ...
                area="思明区",
                indoor_outdoor="indoor",
                location=Location(lat=24.4600, lng=118.0800),
                ticket_price=0,
            ),
            ScoredPOI(
                name="海蛎煎",
        ...
        "青岛": [
            ScoredPOI(
                ...
                category="attraction",
                score=0.85,
                description="青岛地标，百年老桥",
                tags=["地标", "海景", "历史"],
                best_time="上午",
                recommended_hours="1小时",
                area="市南区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.0596, lng=120.3177),
                ticket_price=0,
            ),
            ScoredPOI(
                name="八大关",
                ...
                area="市南区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.0538, lng=120.3508),
                ticket_price=0,
            ),
            ScoredPOI(
                name="崂山",
                ...
                area="崂山区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.1968, lng=120.6237),
                ticket_price=130,
            ),
            ScoredPOI(
                name="五四广场",
                ...
                area="市南区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.0600, lng=120.3850),
                ticket_price=0,
            ),
            ScoredPOI(
                name="青岛啤酒博物馆",
                ...
                area="市北区",
                indoor_outdoor="mixed",
                location=Location(lat=36.0894, lng=120.4110),
                ticket_price=60,
            ),
            ScoredPOI(
                name="小鱼山",
                ...
                area="市南区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.0580, lng=120.3320),
                ticket_price=10,
            ),
            ScoredPOI(
                name="信号山公园",
                category="attraction",
                score=0.8,
                description="红瓦绿树最佳观景点",
                tags=["观景", "园林", "旋转楼"],
                best_time="下午",
                recommended_hours="1-2小时",
                area="市南区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.0700, lng=120.3400),
                ticket_price=15,
            ),
            ScoredPOI(
                name="金沙滩",
                category="attraction",
                score=0.8,
                description="亚洲最佳沙滩之一",
                tags=["海滩", "度假", "亲子"],
                best_time="下午",
                recommended_hours="半天",
                area="黄岛区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.0100, lng=120.2700),
                ticket_price=0,
            ),
            ScoredPOI(
                name="劈柴院",
                category="attraction",
                score=0.75,
                description="青岛老街，特色小吃",
                tags=["古街", "小吃", "传统"],
                best_time="下午",
                recommended_hours="1-2小时",
                area="市南区",
                indoor_outdoor="outdoor",
                location=Location(lat=36.0660, lng=120.3180),
                ticket_price=0,
            ),
            ScoredPOI(
                name="青岛啤酒",
...
{{
  "days": [
    ...
    def _build_poi_context(self, pois: list[ScoredPOI], profile: UserProfile) -> str:
        ...
        for i, poi in enumerate(pois[:35], 1):  # Top 35 POIs
            ...
            if special_reqs:
                req_match = any(kw in special_reqs for kw in [poi.name] + poi.tags)
                if req_match:
                    markers.append("【匹配需求】")
    ...
    def _group_pois_by_area(self, pois: list[ScoredPOI]) -> dict[str, list[ScoredPOI]]:
    ...
    def _mark_time_constraints(self, pois: list[ScoredPOI]) -> list[ScoredPOI]:
    ...
    def _create_meal_activity(self, day_idx: int, meal_type: str, profile: UserProfile) -> Activity:
