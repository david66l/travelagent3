...
class RetrievalFallback:
    ...
    async def fallback(
        ...
        *,
        ...
        if not city:
            return {"poi_candidates": [], "retrieval_empty": True, "fallback_reason": "no_destination"}
        ...
        return {"poi_candidates": [], "retrieval_empty": True, "fallback_reason": "all_strategies_failed"}
    ...
    def _safety_set(city: str) -> list[POI]:
        ...
        safety_data: dict[str, list[dict[str, Any]]] = {
            "北京": [
                {"spot_id": "beijing-001", "spot_name": "故宫博物院", "lat": 39.9163, "lng": 116.3972, "tags": ["历史", "世界文化遗产"]},
                {"spot_id": "beijing-002", "spot_name": "八达岭长城", "lat": 40.3590, "lng": 116.0200, "tags": ["历史", "登山"]},
                {"spot_id": "beijing-003", "spot_name": "天坛公园", "lat": 39.8830, "lng": 116.4120, "tags": ["历史", "公园"]},
                {"spot_id": "beijing-004", "spot_name": "颐和园", "lat": 39.9990, "lng": 116.2750, "tags": ["历史", "园林"]},
                {"spot_id": "beijing-005", "spot_name": "南锣鼓巷", "lat": 39.9370, "lng": 116.4030, "tags": ["美食", "逛街"]},
            ],
            "上海": [
                {"spot_id": "shanghai-001", "spot_name": "外滩", "lat": 31.2397, "lng": 121.4998, "tags": ["夜景", "历史"]},
                {"spot_id": "shanghai-002", "spot_name": "东方明珠", "lat": 31.2397, "lng": 121.4998, "tags": ["地标", "观光"]},
                {"spot_id": "shanghai-003", "spot_name": "豫园", "lat": 31.2270, "lng": 121.4920, "tags": ["园林", "美食"]},
            ],
            "成都": [
                {"spot_id": "chengdu-001", "spot_name": "宽窄巷子", "lat": 30.6680, "lng": 104.0550, "tags": ["美食", "文化"]},
                {"spot_id": "chengdu-002", "spot_name": "武侯祠", "lat": 30.6420, "lng": 104.0470, "tags": ["历史", "三国"]},
                {"spot_id": "chengdu-003", "spot_name": "大熊猫繁育基地", "lat": 30.7340, "lng": 104.1470, "tags": ["亲子", "动物"]},
            ],
        }
